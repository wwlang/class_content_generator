...
This document provides complete HTML templates for all 10 common slide layouts. Each template is designed for **1024x768px (4:3 aspect ratio)** slides with the design philosophy applied.
...
- `h1`: PT Serif 700, 70px, #7373b0
- `.subtitle`: Lato 400, 24px, #475569, margin-top: 20px
- `.author`: Lato 400, 18px, #64748b, margin-top: 40px
...
**CSS Requirements:**
- `.section-break-slide`: `background: #7373b0; display: flex; justify-content: flex-start; align-items: center; padding: 60px;`
- `.section-title`: PT Serif 400, 50px, #ffffff, text-align: left
...
- `.slide-title`: PT Serif 400, 40px, #7373b0, margin-bottom: 40px
- `ul`: List-style-position: outside, padding-left: 30px
- `li`: Lato 400, 18px, #475569, line-height: 1.5, margin-bottom: 16px
...
- `.slide-title`: PT Serif 400, 40px, #7373b0, margin-bottom: 30px
...
- `.icon-container`: `color: #7373b0; margin-bottom: 20px;`
- `.tile h3`: PT Serif 500, 22px, #7373b0, margin-bottom: 12px
- `.tile p`: Lato 400, 16px, #475569, line-height: 1.5

**Note:** Icons should use accent color (#7373b0) for visual pop
...
- `.big-number`: PT Serif 700, 180px, #7373b0 (accent color!)
- `.number-explanation`: Lato 400, 24px, #475569, margin-top: 30px, max-width: 700px
- `.citation`: Lato 400, 14px, #64748b, margin-top: 20px
...
- `.comparison-box h3`: PT Serif 500, 24px, #7373b0, margin-bottom: 20px, text-align: center
- `.comparison-box li`: Lato 400, 16px, #475569, margin-bottom: 12px
...
- `.main-quote`: Lato 400 italic, 28px, #7373b0, border-left: 4px solid #7373b0, padding-left: 30px, margin: 0
- `.quote-attribution`: Lato 500, 20px, #475569, margin-top: 30px
- `.quote-context`: Lato 400, 16px, #64748b, margin-top: 8px
...
- `.profile-card h3`: PT Serif 500, 20px, #7373b0, margin-bottom: 8px
- `.profile-role`: Lato 500, 16px, #7373b0 (accent color!)
- `.profile-detail`: Lato 400, 14px, #64748b, margin-top: 8px
...
- `.thank-you-heading`: PT Serif 700, 60px, #7373b0
- `.closing-subtext`: Lato 400, 24px, #475569, margin-top: 20px, margin-bottom: 60px
- `.contact-info`: `margin-top: 40px;`
- `.contact-item`: Lato 400, 18px, #475569, margin-bottom: 12px
...
- `.citation`: Lato 400, 11px, #64748b, line-height: 1.4, margin-bottom: 4px
...
**CSS Requirements:**
- `.speaker-notes`: `display: none; background: #f8fafc; padding: 20px; margin-top: 20px; border-left: 3px solid #7373b0;`
- `.speaker-notes h4`: PT Serif 500, 14px, #7373b0, margin-bottom: 8px
- `.speaker-notes p`: Lato 400, 12px, #475569, line-height: 1.5
...
- `.vocab-table th`: `background: #7373b0; color: white; padding: 16px; text-align: left; font-family: 'PT Serif'; font-size: 24px;`
- `.vocab-table td`: `padding: 16px; border-bottom: 1px solid #e2e8f0; font-size: 22px; vertical-align: top;`
- `.vocab-table td:first-child`: `font-weight: 500; color: #7373b0;` (English term highlighted)
...
- `.activity-badge`: `background: #7373b0; color: white; padding: 8px 20px; border-radius: 20px; font-size: 18px;`
...
- `.rubric-table th`: `padding: 14px; text-align: left; font-size: 20px; font-family: 'PT Serif';`
- `.criterion-col`: `background: #7373b0; color: white; width: 20%;`
...
- `.criterion-name`: `background: #f8fafc; font-weight: 500; color: #7373b0;`
...
<div class="slide concept-map-slide" data-slide="N">
  ...
  <div class="concept-map">
    ...
    <svg class="connection-lines" width="100%" height="100%">
      <line x1="50%" y1="50%" x2="25%" y2="30%" stroke="#7373b0" stroke-width="3"/>
      <line x1="50%" y1="50%" x2="75%" y2="30%" stroke="#7373b0" stroke-width="3"/>
      <line x1="50%" y1="50%" x2="25%" y2="70%" stroke="#7373b0" stroke-width="3"/>
      <line x1="50%" y1="50%" x2="75%" y2="70%" stroke="#7373b0" stroke-width="3"/>
    </svg>
  </div>
...
- `.concept-node`: `position: absolute; background: white; border: 3px solid #7373b0; border-radius: 15px; padding: 20px; text-align: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1);`
- `.concept-central`: `left: 50%; top: 50%; transform: translate(-50%, -50%); background: #7373b0; color: white; width: 220px; z-index: 10;`
...
- `.concept-node h4`: `font-size: 24px; margin-bottom: 6px; color: #7373b0;`
...
- `.step-number`: `background: #7373b0; color: white; width: 50px; height: 50px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 28px; font-weight: 700; flex-shrink: 0;`
- `.step-content h4`: `font-size: 24px; color: #7373b0; margin-bottom: 8px;`

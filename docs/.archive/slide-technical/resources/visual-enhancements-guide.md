...
- **#ed5e29** (Orange) - Accent color for emphasis, titles, icons, key concepts
- **#131313** (Dark gray) - Primary text color
- **#f4f3f1** (Cream) - Slide background (warm, reduces eye strain)
...
**Orange Accent (#ed5e29):**
- **Cognitive Effects:** Energy, enthusiasm, creativity, warmth
- **Learning Context:** Draws attention, stimulates engagement, creates excitement
- **Use Cases:** Key concepts, emphasis points, interactive elements, icons
- **Caution:** Use sparingly for maximum impact; reserve for truly important elements

**Dark Gray Text (#131313):**
- **Cognitive Effects:** Authority, sophistication, high readability
- **Learning Context:** Professional, clear, supports focus on content
- **Use Cases:** Primary text, headings, main content

**Cream Background (#f4f3f1):**
- **Cognitive Effects:** Warmth, comfort, reduces eye strain vs pure white
- **Learning Context:** Creates welcoming atmosphere, softer than stark white
- **Use Cases:** Slide backgrounds, reduces harsh contrast
...
```
#ed5e29 (Orange - Primary Accent) → Key concepts, emphasis, calls-to-action
...
#3b82f6 (Blue) → Questions, thought exercises, discussion
```

**2. Color Contrast for Emphasis**

Use the **70-25-5 Rule:**
- **70%** → Neutral colors (cream background, dark gray text)
- **25%** → Supporting color (tan for borders, muted gray for secondary text)
- **5%** → Accent color for critical emphasis (orange #ed5e29 for key concepts, icons, CTAs)
...
```css
/* Most important */
color: #ed5e29; font-size: 40px; font-weight: 700;

/* Secondary importance */
color: #ed5e29; font-size: 30px; font-weight: 400;
...
- **Headings:** Always #ed5e29 (creates visual anchor)
- **Key terms:** Bold + #ed5e29 (e.g., `<strong style="color: #ed5e29">`)
...
.bar {
  width: 100%;
  background: linear-gradient(180deg, #ed5e29 0%, #8b87c7 100%);
...
- Use monochromatic gradient (light to dark #ed5e29)
...
- Example: Blue (#ed5e29) vs Amber (#f59e0b)

**Sequential Data:**
- Three-color gradient: Light → Medium → Dark
- Example: #c7d2fe → #ed5e29 → #4c1d95
...
.data-value {
  ...
  font-size: 32px;
  font-weight: 700;
  color: white; /* or #ed5e29 for light backgrounds */
}
...
**Our System: Cal Sans + Plus Jakarta Sans**
...
strong {
  ...
  color: #ed5e29; /* Accent color for key terms */
}
...
- #ed5e29 on #ffffff = 4.73:1 ✓ (meets AA for large text)

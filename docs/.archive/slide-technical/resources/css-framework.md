...
:root {
  ...
  --color-accent: #ed5e29;       /* Orange - brand/accent color */
  --color-cream: #f4f3f1;        /* Cream - slide backgrounds */
  --color-tan: #cac3b7;          /* Tan - decorative elements */
  --color-white: #ffffff;        /* White - cards, contrast */
  --color-muted: #64748b;        /* Muted gray - secondary text */
  --color-light-gray: #f1f5f9;   /* Light gray - borders */
  --color-border: #cbd5e1;       /* Border color */
  --color-quote-mark: #e2e8f0;   /* Quote decoration */

  /* Legacy color mappings (auto-converted to new palette) */
  --color-secondary: #131313;    /* Maps to primary */
  --color-background: #f4f3f1;   /* Maps to cream */
  --color-stage: #e5e5e5;        /* Stage background */
  --color-light-bg: #f4f3f1;     /* Maps to cream */

  /* Typography - Reference Design System */
...
/* ========================================
   SLIDE BASE STYLES & BACKGROUND POLICY
   ======================================== */

/* BACKGROUND POLICY:
   All slides default to cream background (var(--color-cream) = #f4f3f1).
   ONLY these slide types override the background:
   1. .title-slide (cream with decorative shapes)
   2. .section-break-slide (orange #ed5e29)
   3. .dark-bg (dark gray #131313)
   ...
   MUST use the default cream background. */

.slide {
  width: var(--slide-width);
  height: var(--slide-height);
  background: var(--color-cream);  /* Default cream for ALL slides */
...
.slide.dark-bg {
  background: var(--color-primary);  /* Override for dark slides */
}
...
/* Grid heading styling - automatically applied by converter */
.grid-2-col h3,
.grid-3-col h3 {
  font-family: var(--font-header);
  font-size: 20px;
...
/* ========================================
   LAYOUT: FRAMEWORK SLIDE (Component Grid)
   ======================================== */
...
/* Responsive grid based on component count */
.framework-components[data-count="1"],
.framework-components[data-count="2"],
.framework-components[data-count="3"] {
  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));
}

.framework-components[data-count="4"] {
  grid-template-columns: repeat(2, 1fr);
}

.framework-components[data-count="5"],
.framework-components[data-count="6"] {
  grid-template-columns: repeat(3, 1fr);
}
...
/* Framework commentary - general statements below component grid */
...
/* ========================================
   LAYOUT: COMPARISON TABLE (Multi-Column)
   ======================================== */
...
.comparison-table-slide tbody tr:hover {
  background: #f8fafc;
}

.comparison-table-slide tbody tr:first-child td {
  border-top: none;
}
```
...
**NEW: Multi-Column Grids with Automatic Styling**

Grid layouts are now automatically styled with the reference design colors:
...
- ✓ Grid h3 headers: Cal Sans font, orange color (#ed5e29), 20px, bold
- ✓ Bullets: Orange color, proper indentation
- ✓ Full-width layout with equal columns
- ✓ 30px gap between columns
- ✓ Works for `.grid-2-col` (2 columns) or `.grid-3-col` (3 columns)

**No Manual Styling Required:** Just use semantic HTML (`<h3>` + `<ul>`) and the CSS automatically applies all styling.

**PPTX Conversion:** The HTML-to-PPTX converter automatically detects grid layouts and creates properly formatted multi-column slides with orange headers and bullets.

### Reference Design System (Updated 2025)

The CSS framework now uses the updated reference design:

**Colors:**
- Primary text: Dark gray (#131313)
- Accent/Brand: Orange (#ed5e29) - used for headers, bullets, emphasis
- Backgrounds: Cream (#f4f3f1) for slides, white (#ffffff) for cards
- Decorative: Tan (#cac3b7)

**Fonts:**
- Headers: Cal Sans (condensed letter-spacing: -0.05em)
- Body: Plus Jakarta Sans

**Legacy Compatibility:** Old color variables (--color-primary purple #7373b0) automatically map to new colors for backward compatibility.
